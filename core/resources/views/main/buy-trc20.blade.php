...
<head>
    ...
    <title> TMC P2P Exchange - Buy USDT TRC20</title>

    <meta name="title" Content="TMC P2P Exchange - Buy USDT TRC20">
    ...
    <meta name="apple-mobile-web-app-title" content="TMC P2P Exchange - Buy USDT TRC20">
    
    <meta itemprop="name" content="TMC P2P Exchange - Buy USDT TRC20">
    ...
    <meta property="og:url" content="http://localhost/p2pexchange/p2pexchange/ads/buy/USDT%20TRC20/all">
...
<body>
        ...
        <div class="container">
            <nav class="navbar navbar-expand-xl p-0 align-items-center">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <section class="inner-hero bg_img" data-background="assets/images/frontend/breadcrumb/62b1a27b85b171655808635.jpg">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-6 text-center">
          <h2 class="page-title">Buy USDT TRC20</h2>
        </div>
      </div>
    </div>
</section>
            ...
            <div class="container">
                <form class="coin-search-form buy--sell-filter"  method="GET">
                    <div class="row align-items-end gy-3">
                        ...
                        <div class="col-xxl-2 col-md-4 col-sm-6">
                            <label>Limit</label>
                            <input type="number" step="any" value="" placeholder="Enter Amount" class="form-control amount">
                        </div>
                        <div class="col-xxl-1">
                            <button type="submit" class="btn--base w-100 px-xxl-2"> <i class="la la-search" aria-hidden="true"></i> Search</button>
                        </div>
                    </div>
                </form>
            </div>
                                ...
                                <table class="table custom--table mb-0">
                                    ...
                                    <tbody>
                                                ...
                                                <td colspan="100%" class="text-center">
                                                    <div class="no-data-message bg-white p-5">
    ...
    <p class="message">No advertisement found</p>
</div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 mt-md-0 mt-3">
                    <ul class="link-list justify-content-md-end justify-content-center">
                                                    <li>
                                <a href="http:">Terms of Service</a>
                            </li>
                                                    <li>
                                <a href="http:">Privacy Policy</a>
                            </li>
                                            </ul>
                </div>
            </div>
