            ...
            <div class="sidebar__inner">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu  ">
                        <ul>
                            <li class="sidebar-menu-item ">
                                <a href="http://localhost/dynamicLaravel10/admin/usersadmin/limit" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                            ...
                            <li class="sidebar-menu-item ">
                                <a href="http://localhost/dynamicLaravel10/admin/usersadmin/advertisement" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu  ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item ">
                                <a href="http://localhost/dynamicLaravel10/admin/usersadmin/trade/running" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                            ...
                            <li class="sidebar-menu-item ">
                                <a href="http://localhost/dynamicLaravel10/admin/usersadmin/trade/reported" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                            ...
                            <li class="sidebar-menu-item ">
                                <a href="http://localhost/dynamicLaravel10/admin/usersadmin/trade/completed" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                              ...
                              <li class="sidebar-menu-item ">
                                <a href="http://localhost/dynamicLaravel10/admin/usersadmin/trade" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                        ...
                        <!-- <li class="sidebar-menu-item ">
                    <a href="http://localhost/dynamicLaravel10/admin/crypto-currencies" class="nav-link ">
                        ...
                        <!-- <li class="sidebar-menu-item ">
                    <a href="http://localhost/dynamicLaravel10/admin/fiat-currencies" class="nav-link ">
                ...
                <li class="sidebar-menu-item ">
                    <a href="http://localhost/dynamicLaravel10/admin/usersadmin/fiat-gateways" class="nav-link ">
                        ...
                        <!-- <li class="sidebar-menu-item ">
                    <a href="http://localhost/dynamicLaravel10/admin/payment-window" class="nav-link ">
                        <i class="menu-icon las la-stopwatch"></i>
                        <span class="menu-title">Payment Windows</span>
                    </a>
                </li> -->
                               <!-- <li class="sidebar-menu-item  ">
                                        <a href="http://localhost/dynamicLaravel10/admin/withdraw/log" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                     ...
                     <li class="sidebar-menu-item sidebar-dropdown">
                            ...
                            <div class="sidebar-submenu  ">
                                <ul>
                                    ...
                                    <!-- <li class="sidebar-menu-item  ">
                                        <a href="http://localhost/dynamicLaravel10/admin/withdraw/rejected" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Level Income</span>
                                        </a>
                                    </li>
                        ...
                        <li class="sidebar-menu-item sidebar-dropdown">
                            ...
                            <div class="sidebar-submenu  ">
                                <ul>
                                    ...
                                    <!-- <li class="sidebar-menu-item  ">
                                        <a href="http://localhost/dynamicLaravel10/admin/ticket/closed" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Closed Ticket</span>
                                        </a>
                                    </li> -->
                                    <!-- <li class="sidebar-menu-item  ">
                                        <a href="http://localhost/dynamicLaravel10/admin/ticket/answered" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu  ">
                        <ul>
                            <li class="sidebar-menu-item ">
                                <a href="http://localhost/dynamicLaravel10/admin/usersadmin/report/transaction" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                            ...
                            <li class="sidebar-menu-item ">
                                <a href="http://localhost/dynamicLaravel10/admin/usersadmin/report/login/history" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                            ...
                            <li class="sidebar-menu-item ">
                                <a href="http://localhost/dynamicLaravel10/admin/usersadmin/report/notification/history" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                        ...
                        <!-- <li class="sidebar-menu-item  ">
                    <a href="http://localhost/dynamicLaravel10/admin/subscriber" class="nav-link"
                       data-default-url="http://localhost/dynamicLaravel10/admin/subscriber">
                 ...
                 -->
                        ...
                        <li class="sidebar-menu-item ">
                            <a href="http://localhost/dynamicLaravel10/admin/general-setting" class="nav-link">
                        ...
                        <li class="sidebar-menu-item ">
                            <a href="http://localhost/dynamicLaravel10/admin/setting/system-configuration" class="nav-link">
                        ...
                        <li class="sidebar-menu-item ">
                            <a href="http://localhost/dynamicLaravel10/admin/cron/index" class="nav-link">
                        ...
                        <li class="sidebar-menu-item ">
                            <a href="http://localhost/dynamicLaravel10/admin/api-setting" class="nav-link">
                        ...
                        <li class="sidebar-menu-item ">
                            <a href="http://localhost/dynamicLaravel10/admin/referral" class="nav-link ">
                    ...
                    <a href="{{route('admin.kyc.setting')}}" class="nav-link">
                        ...
                        <!-- <li class="sidebar-menu-item sidebar-dropdown">
                            ...
                            <div class="sidebar-submenu  ">
                                <ul>
                                    <li class="sidebar-menu-item  ">
                                        <a href="http://localhost/dynamicLaravel10/admin/notification/global" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Global Template</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item  ">
                                        <a href="http://localhost/dynamicLaravel10/admin/notification/email/setting" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Email Setting</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item  ">
                                        <a href="http://localhost/dynamicLaravel10/admin/notification/sms/setting" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">SMS Setting</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item  ">
                                        <a href="http://localhost/dynamicLaravel10/admin/notification/push-notification/setting" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Push Notification Setting</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item  ">
                                        <a href="http://localhost/dynamicLaravel10/admin/notification/templates" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                        ...
                        <li class="sidebar-menu-item ">
                            <a href="http://localhost/dynamicLaravel10/admin/frontend/templates" class="nav-link ">
                        ...
                        <li class="sidebar-menu-item ">
                            <a href="http://localhost/dynamicLaravel10/admin/frontend/manage-pages" class="nav-link ">
                                <i class="menu-icon la la-list"></i>
                        ...
                        <li class="sidebar-menu-item sidebar-dropdown">
                            ...
                            <div class="sidebar-submenu  ">
                                <ul>
                                    <li class="sidebar-menu-item   ">
                                        <a href="http://localhost/dynamicLaravel10/admin/frontend/frontend-sections/advertisement" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Advertisement Page</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item   ">
                                        <a href="http://localhost/dynamicLaravel10/admin/frontend/frontend-sections/banner" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Banner Section</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item   ">
                                        <a href="http://localhost/dynamicLaravel10/admin/frontend/frontend-sections/breadcrumb" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Breadcrumb</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item   ">
                                        <a href="http://localhost/dynamicLaravel10/admin/frontend/frontend-sections/buy" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Buy Section</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item   ">
                                        <a href="http://localhost/dynamicLaravel10/admin/frontend/frontend-sections/choose_us" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Why Choose Us</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item   ">
                                        <a href="http://localhost/dynamicLaravel10/admin/frontend/frontend-sections/contact" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Contact Page</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item   ">
                                        <a href="http://localhost/dynamicLaravel10/admin/frontend/frontend-sections/faq" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">FAQ Section</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item   ">
                                        <a href="http://localhost/dynamicLaravel10/admin/frontend/frontend-sections/footer" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Footer Section</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item   ">
                                        <a href="http://localhost/dynamicLaravel10/admin/frontend/frontend-sections/kyc" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">KYC Message</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item   ">
                                        <a href="http://localhost/dynamicLaravel10/admin/frontend/frontend-sections/login" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Login Page</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item   ">
                                        <a href="http://localhost/dynamicLaravel10/admin/frontend/frontend-sections/offer" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Offer Section</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item   ">
                                        <a href="http://localhost/dynamicLaravel10/admin/frontend/frontend-sections/overview" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Overview Section</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item   ">
                                        <a href="http://localhost/dynamicLaravel10/admin/frontend/frontend-sections/policy_pages" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Policy Pages</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item   ">
                                        <a href="http://localhost/dynamicLaravel10/admin/frontend/frontend-sections/registration" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Registration Page</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item   ">
                                        <a href="http://localhost/dynamicLaravel10/admin/frontend/frontend-sections/sell" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Sell Section</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item   ">
                                        <a href="http://localhost/dynamicLaravel10/admin/frontend/frontend-sections/social_icon" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Social Icons</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item   ">
                                        <a href="http://localhost/dynamicLaravel10/admin/frontend/frontend-sections/subscribe" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Subscribe Section</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item   ">
                                        <a href="http://localhost/dynamicLaravel10/admin/frontend/frontend-sections/testimonial" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
...
<!-- 
                        <li class="sidebar-menu-item ">
                            <a href="http://localhost/dynamicLaravel10/admin/maintenance-mode" class="nav-link">
                        ...
                        <li class="sidebar-menu-item ">
                            <a href="http://localhost/dynamicLaravel10/admin/cookie" class="nav-link">
                        ...
                        <li class="sidebar-menu-item sidebar-dropdown">
                            ...
                            <div class="sidebar-submenu  ">
                                <ul>
                                    <li class="sidebar-menu-item  ">
                                        <a href="http://localhost/dynamicLaravel10/admin/system/info" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Application</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item  ">
                                        <a href="http://localhost/dynamicLaravel10/admin/system/server-info" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Server</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item  ">
                                        <a href="http://localhost/dynamicLaravel10/admin/system/optimize" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Cache</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item  ">
                                        <a href="http://localhost/dynamicLaravel10/admin/system/system-update" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                        ...
                        <li class="sidebar-menu-item ">
                            <a href="http://localhost/dynamicLaravel10/admin/custom-css" class="nav-link">
                        ...
                        <li class="sidebar-menu-item  ">
                            <a href="{{route('admin.logout')}}" class="nav-link"
                                data-default-url="http://localhost/dynamicLaravel10/admin/request-report">
                ...
                <ul class="navbar__action-list">
                    ...
                    <li class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu--md p-0 border-0 box--shadow1 dropdown-menu-right">
                            ...
                            <div class="dropdown-menu__footer">
                                <a href="http://localhost/dynamicLaravel10/admin/notifications"
                    ...
                    <li class="dropdown">
                        <button type="button" class="" data-bs-toggle="dropdown" data-display="static" aria-haspopup="true"
                            ...
                            <span class="navbar-user">
                                <span class="navbar-user__thumb"><img
                                        src="http://localhost/dynamicLaravel10/assets/images/default.png"
                                        alt="image"></span>
                        ...
                        <div class="dropdown-menu dropdown-menu--sm p-0 border-0 box--shadow1 dropdown-menu-right">
                            <a href="http://localhost/dynamicLaravel10/admin/profile"
                                class="dropdown-menu__item d-flex align-items-center px-3 py-2">
                                <i class="dropdown-menu__icon las la-user-circle"></i>
                                <span class="dropdown-menu__caption">Profile</span>
                            </a>

                            <a href="http://localhost/dynamicLaravel10/admin/password"
                                class="dropdown-menu__item d-flex align-items-center px-3 py-2">
