                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group ">
                                        ...
                                        <input class="form-control" name="site_name" required type="text" value="LocalCoins">
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group ">
                                        <label> Completed Trade Charge</label>
                                        <div class="input-group">
                                            <input class="form-control" min="0" name="trade_charge" required step="0.01" type="number" value="2">
                                ...
                                <div class="form-group  col-sm-6">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text p-0 border-0">
                                            <input class="form-control colorPicker" type='text' value="FCA120">
                                        </span>
                                        <input class="form-control colorCode" name="base_color" type="text" value="FCA120">
                                    </div>
                                </div>
                                <div class="form-group  col-sm-6">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text p-0 border-0">
                                            <input class="form-control colorPicker" type='text' value="">
                                        </span>
                                        <input class="form-control colorCode" name="secondary_color" type="text" value="">
                                    </div>
                                </div>
