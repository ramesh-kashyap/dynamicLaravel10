...
<div class="body-wrapper">
    <div class="bodywrapper__inner">
        ...
        <div class="d-flex mb-30 flex-wrap gap-3 justify-content-between align-items-center">
            <h6 class="page-title">Direct Income </h6>
...
<div class="table-responsive">
                            <table class="table table--light style--two">
                                ...
                                <tbody>
                                    @php
                                        $sr = ($direct_incomes->currentPage() - 1) * $direct_incomes->perPage() + 1;
                                    @endphp

                                    @forelse($direct_incomes as $value)
                                    <tr>
                                        <td>{{ $sr++ }}</td>
    ...
    {{ $direct_incomes->onEachSide(1)->links('pagination::bootstrap-4') }}
</div>
