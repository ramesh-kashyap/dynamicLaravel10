...
<div class="body-wrapper">
    <div class="bodywrapper__inner">
        ...
        <div class="d-flex mb-30 flex-wrap gap-3 justify-content-between align-items-center">
            <h6 class="page-title">Total User </h6>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                    ...
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table table--light style--two">
                                ...
                                <tbody>
                                    @php
                                    $sr = ($alluserlist->currentPage() - 1) * $alluserlist->perPage() + 1;
                                    @endphp

                                    @forelse($alluserlist as $value)
                                    <tr>
                                        <td>{{ $sr++ }}</td>
                ...
                <div class="custom-pagination text-center mt-4">
                    {{ $alluserlist->onEachSide(1)->links('pagination::bootstrap-4') }}
                </div>
