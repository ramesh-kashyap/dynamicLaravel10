...
if (isset($_GET['second_color']) and $_GET['second_color'] != '') {
    $secondColor = "#" . $_GET['second_color'];
}
...
if (isset($_GET['third_color']) and $_GET['third_color'] != '') {
    $thirdColor = "#" . $_GET['third_color'];
}
