                                ...
                                @elseif($content == 'icon')
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control iconPicker icon" data-icon="{{ @$data->data_values->$k ? @$data->data_values->$k : '<i class="las la-home"></i>' }}" autocomplete="off" name="{{ $k }}" value="{{ @$data->data_values->$k }}" required>
...
@push('breadcrumb-plugins')
    <a href="{{ route('admin.frontend.sections', request()->key) }}" class="btn btn-sm btn-outline--primary"><i class="las la-undo"></i>@lang('Back')</a>
@endpush
...
@push('script')
    <script>
        (function($) {
            ...
            $(document).find('.iconpicker-container .input-group-text').html($('.iconPicker').data('icon'));
