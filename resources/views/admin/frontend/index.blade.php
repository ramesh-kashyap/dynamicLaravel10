                                                ...
                                                <td>
                                                    <div class="customer-details d-block">
                                                        <a class="thumb" href="javascript:void(0)">
                                                            <img alt="@lang('image')" src="{{ getImage('assets/images/frontend/' . $key . '/' . @$data->data_values->$firstKey, @$section->element->images->$firstKey->size) }}">
                                                        </a>
                                                    </div>
                                                </td>
                                            @endif
                                            ...
                                            <td>
                                                <div class="button--group">
                                                    @if ($section->element->modal)
                                                        ...
                                                        @endphp
                                                        <button @if (@$section->element->images) data-images="{{ json_encode($images) }}" @endif class="btn btn-sm btn-outline--primary updateBtn" data-all="{{ json_encode($data->data_values) }}" data-id="{{ $data->id }}">
        ...
        <div class="modal fade" id="updateBtn" role="dialog" tabindex="-1">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('admin.frontend.sections.content', $key) }}" class="edit-route" enctype="multipart/form-data" method="POST">
                        @csrf
                        <input name="type" type="hidden" value="element">
                                ...
                                @if ($k != 'modal')
                                    @if ($type == 'icon')
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input autocomplete="off" class="form-control iconPicker icon" data-icon="" name="{{ $k }}" required type="text">
                                                <span class="input-group-text input-group-addon" data-icon="las la-home" role="iconpicker"></span>
                                            </div>
                                        </div>
                                    @elseif($k == 'select')
    ...
    <script>
        (function($) {
            ...
            $('.addBtn').on('click', function() {
                var modal = $('#addModal');
                let iconpicker = modal.find('.iconPicker');
                modal.modal('show');
            });
            $('.updateBtn').on('click', function() {
                ...
                modal.find('.iconpicker-container .input-group-text').html(modal.find('.iconPicker').val());
