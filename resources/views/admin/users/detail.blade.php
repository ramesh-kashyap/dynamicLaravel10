    ...
    <div class="row">
        <div class="col-12">
            <div class="row gy-4">
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--19">
                        ...
                        <div class="widget-two__content">
                            <h3 class="text-white">{{ $totalAd }}</h3>
                            <p class="text-white">@lang('Total Advertisements')</p>
                        </div>
                        <a href="{{ route('admin.ad.index') }}?search={{ $user->username }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--primary">
                        ...
                        <div class="widget-two__content">
                            <h3 class="text-white">{{ $totalDeposit }}</h3>
                            <p class="text-white">@lang('Total Deposits')</p>
                        </div>
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--1">
                        ...
                        <div class="widget-two__content">
                            <h3 class="text-white">{{ $totalWithdrawals }}</h3>
                            <p class="text-white">@lang('Total Withdrawals')</p>
                        </div>
                        <a href="{{ route('admin.withdraw.approved') }}?search={{ $user->username }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
                    ...
                    <div class="col-xxl-3 col-sm-6">
                        <div class="widget-two box--shadow2 b-radius--5 bg--white">
                            <div class="widget-two__icon b-radius--5">
                                <img src="{{ getImage($walletImage->path . '/' . $wallet->crypto->image, $walletImage->size) }}" alt="image">
                            </div>
                            <div class="widget-two__content">
                                <h3>{{ showAmount($wallet->balance, 8) }} {{ __($wallet->crypto->code) }}</h3>
                                <p>@lang('Total Balance')</p>
                                <span>@lang('In USD')</span>
                                <i class="fas fa-arrow-right text--primary"></i>
                                <span class="text--primary">{{ showAmount($wallet->balance * $wallet->crypto->rate) }}</span>
                            </div>
                        </div>
                    </div>
                @endforeach
            ...
            <div class="d-flex flex-wrap gap-3 mt-4">
                ...
                @if ($user->kyc_data)
                    <div class="flex-fill">
                        <a href="{{ route('admin.users.kyc.details', $user->id) }}" target="_blank" class="btn btn--info btn--shadow w-100 btn-lg">
                                    ...
                                    <div class="image-upload">
                                        <div class="thumb">
                                            ...
                                            <div class="avatar-preview">
                                                <div class="profilePicPreview" style="background-image: url({{ getImage($profileImage->path . '/' . @$user->image, null, true) }})">
    ...
    <script>
        (function($) {
            ...
            $('select[name="wallet_id"]').on('change', function() {
                ...
                $('#addSubModal').find('.code').text(code);
            }).change();
