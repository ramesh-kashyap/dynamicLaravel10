    ...
    <div class="review-item mb-4">
        <div class="review-header d-flex flex-wrap justify-content-between align-items-center gap-3 mb-3">
            <div class="review-user d-flex flex-wrap gap-2 align-items-center">
                <img src="{{ getImage(getFilePath('userProfile') . '/' . @$review->user->image, null, true) }}" alt="image" class="mt-0 user-image">
            ...
            <div class="d-flex gap-2">
                ...
                @if ($review->user->id == auth()->id())
                    <button class="text--base bg-transparent editBtn fs--14px" data-feedback="{{ $review->feedback }}" data-type="{{ $review->type }}" data-id="{{ $review->tradeRequest?$review->tradeRequest->uid:0 }}"><i class="fas fa-pencil-alt fs--13px"></i> @lang('Edit')</button>
                @endif
            </div>
        </div>
        ...
        <div class="modal-content">
            ...
            <form class="contact-form give-review-form" method="POST">
                            ...
                            <div class="contact-form-wrapper">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-12 form-group">
                                        ...
                                        <textarea name="feedback" rows="4" placeholder="@lang('Your feedback')" class="form-control check-length user-feedback" id="check-length" data-length="500">{{ old('feedback') }}</textarea>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-sm btn--base w-100"> @lang('Update')
                    </button>
                </div>
            </form>
