            ...
            <div class="single-slide">
                <div class="testimonial-card">
                    ...
                    <div class="testimonial-card__client text-center mt-4">
                        <div class="thumb"><img src="{{ getImage('assets/images/frontend/testimonial/'.@$testimonial->data_values->image,'450x475') }}" alt="image"></div>
                        <h6 class="name mt-2">{{__(@$testimonial->data_values->author_name)}}</h6>
                    </div>
                </div>
            </div>
        @endforeach
