                ...
                <div class="card custom--card">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('ticket.reply', $myTicket->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="text-end">
                                <a href="javascript:void(0)" class="btn btn--base btn-sm addFile mt-4"><i class="fa fa-plus"></i> @lang('Add New')</a>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="file" name="attachments[]" class="form-control custom-input-field" />
